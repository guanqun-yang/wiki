...
+ School course: This is the most important source of information, without which
  I probably still do random search in a /nearly/ infinite "learning space". 
  ...
  2. STAT 202A: Statistical Computing
     ...
     both of which are largely negelected even in advanced level courses. The
     instroctor, Prof. Ying-Nian Wu, could dive into low level computation or 
  ...
  3. CS 260: Machine Learning Algorithms
     ...
     "why machine could learn" and "how well machine could learn". Even though
...
+ Project experiences: 
  Though this may not seem to be directly releated to this set of notes, doing
  projects for project-based course or Kaggle let me know the power of machine
...
may inlucde ~Motivation~, ~Algorithm~, ~Discussion~ and ~Computation~. However, 
when discussing learning theory, such layouts will not be followed.
{{{NEWLINE}}}
#+INCLUDE: "ml/learning.org" :minlevel 1
{{{NEWLINE}}}
#+INCLUDE: "ml/linear.org" :minlevel 1
{{{NEWLINE}}}
#+INCLUDE: "ml/logistic.org" :minlevel 1
